# estimate natural mortality rate using values from Pauly's empirical equation for the data of Wang et al.(2020)
...
file2<-paste("M_",as.character(year),"_statistics.csv",sep="")
file3<-paste("M_",as.character(year),"_mcmc.csv",sep="")
